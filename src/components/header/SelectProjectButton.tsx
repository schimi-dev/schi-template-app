                    ...
                    {projects.map(x => (
                        <Menu.Item key={x.id} as={Fragment} >
                            {({ active }) => (
                                <button
                                    className={active ?
                                        "w-full flex items-center px-4 py-2 gap-2 text-sm bg-secondary-100 dark:bg-secondary-700" :
                                        "w-full flex items-center px-4 py-2 gap-2 text-sm hover:bg-secondary-100 dark:hover:bg-secondary-700"
                                    }
