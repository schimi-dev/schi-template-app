    ...
    return (
        <Dialog open={open} onClose={onClose}>
            ...
            <div className="z-50 fixed inset-0 flex items-center justify-center p-4">
                <Dialog.Panel className="border shadow-2xl bg-white dark:bg-secondary-800 border-secondary-200 dark:border-secondary-700 rounded-md p-5 flex flex-col gap-4 w-full max-w-xl">
