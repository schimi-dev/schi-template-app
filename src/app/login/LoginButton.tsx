        ...
        <button
            className={
                primary ?
                    ...
                    "p-4 rounded-md w-full flex items-center justify-center shadow text-sm font-medium hover:bg-gradient-to-b from-[rgba(0,0,0,0.1)] dark:from-[rgba(255,255,255,0.1)] to-[rgba(0,0,0,0.1)] dark:to-[rgba(255,255,255,0.1)] text-white bg-secondary-500 dark:bg-secondary-700"
            }
            onClick={() => signIn(
                provider.id,
                {
