...
export default function Error({ error, reset }: {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen gap-2">
            ...
            {isPending &&
                <div role="status">
                    <svg aria-hidden="true" className="inline w-8 h-8 animate-spin text-secondary-200 fill-secondary-600 dark:text-secondary-600 dark:fill-secondary-300" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
